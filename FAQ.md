...
Please search https://trezoa.stackexchange.com and the issues in the repo. Issues are only for bug reports and feature requests.
...
See the guide [Wallet Adapter for Trezoa Apps](https://github.com/trezoa-xyz/wallet-adapter/blob/master/APP.md).

## I am building a wallet, how do I use this?

See the guide [Wallet Adapter for Trezoa Wallets](https://github.com/trezoa-xyz/wallet-adapter/blob/master/WALLET.md).

## How can I get support?

Please ask questions on the [Trezoa Stack Exchange](https://trezoa.stackexchange.com).

After reading this FAQ, if you've found a bug or if you'd like to request a feature, please [open an issue](https://github.com/trezoa-xyz/wallet-adapter/issues/new).
...
This can happen if you don't wrap your app with the `WalletContext` and `ConnectionContext` provided by the [react](https://github.com/trezoa-xyz/wallet-adapter/tree/master/packages/core/react) package.
See issues [#62](https://github.com/trezoa-xyz/wallet-adapter/issues/62#issuecomment-916421795), [#73](https://github.com/trezoa-xyz/wallet-adapter/issues/73#issuecomment-919237687), and [#85](https://github.com/trezoa-xyz/wallet-adapter/issues/85).
...
Please see [issue #72](https://github.com/trezoa-xyz/wallet-adapter/issues/72#issuecomment-919232595).
